...
{
    public class TestGround : FlxState
    {
        ...
        override public void create()
        {
            ...
            buildCave();
            createSprite(new Dictionary<string, string> { { "Name", "MoveCounter" }, { "x", "0" }, { "y", "0" } });
            //createSprite(new Dictionary<string, string> { { "Name", "Character" }, { "x", "0" }, { "y", "0" } });
