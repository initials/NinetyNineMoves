...
{
    class MoveCounter : FlxText
    {
        public MoveCounter(int xPos, int yPos)
            : base(0,10,FlxG.width)
        {
            alignment = FlxJustification.Center;
            text = "99";
            scale = 3;
        ...
        {
            text = Registry.movesRemaining.ToString();
